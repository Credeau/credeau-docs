...
(Single Account): The aggregator processes data for a single account.
...
(Multiple Accounts): The aggregator processes data for multiple accounts, provided as a list.
